...
Density = rbind(Density, table_from_text("
	name dx dy dz   comment
	rh0   0  0  0   rho0
	rh1   1  0  0   rho1
	rh2   0  1  0   rho2
...
Settings = table_from_text("
	...
	InitDensity               NA                      NA   'initial density'
        SolidDensity              NA                      NA   'initial density in Solid cells'
        WallDensity               NA                      NA   'density on walls'
	Tension                   NA                      NA   'tension'
	EOSScale                  NA                      NA   'scaling of EOS'
	ULimit                    NA                      NA   'Limiter for velocity'
")
