...
Density = table_from_text("
	...
	f[7] -1 -1  0   density7
	f[8]  1 -1  0   density8
	dev1  0  0  0   deviator1
	dev2  0  0  0   deviator2
")
...
Settings = table_from_text("
	...
	SolidInt                  NA                      NA   'Solid integration factor'
	SolidRel                  NA                      NA   'Solid relaxation factor'
")
...
f = PV(Density$name[1:9])
U = as.matrix(Density[1:9,c("dx","dy")])
