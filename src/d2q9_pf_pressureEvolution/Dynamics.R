...
AddSetting(name="nu_l", omega_l='1.0/(3*nu_l)', default=0.33333333, comment='viscosity')
AddSetting(name="nu_h", omega_h='1.0/(3*nu_h)', default=0.33333333, comment='viscosity')
...
AddSetting(name="GravitationX", default=0.0, comment='applied (rho)*BuoyancyX')
AddSetting(name="GravitationY", default=0.0, comment='applied (rho)*BuoyancyY')
