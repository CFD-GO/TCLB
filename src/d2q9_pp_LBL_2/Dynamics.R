...
# Model Specific
AddSetting(name="G", default=-1,     comment='interaction strength' )
AddSetting(name="T", default=0.0585, comment='effective temperature')
AddSetting(name="alpha", R='alpha' , default=0.25, comment='CS EoS parameter'     )
AddSetting(name="R"    , 			   comment='CS EoS parameter'     )
