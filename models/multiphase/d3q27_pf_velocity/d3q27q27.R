...
AddDensity( name="h15",dx= 1, dy= 1, dz= 0, group="g")
AddDensity( name="h16",dx=-1, dy= 1, dz= 0, group="g")
AddDensity( name="h17",dx= 1, dy=-1, dz= 0, group="g")
AddDensity( name="h18",dx=-1, dy=-1, dz= 0, group="g")
AddDensity( name="h19",dx= 1, dy= 0, dz= 1, group="g")
AddDensity( name="h20",dx=-1, dy= 0, dz= 1, group="g")
AddDensity( name="h21",dx= 1, dy= 0, dz=-1, group="g")
AddDensity( name="h22",dx=-1, dy= 0, dz=-1, group="g")
AddDensity( name="h23",dx= 0, dy= 1, dz= 1, group="g")
AddDensity( name="h24",dx= 0, dy=-1, dz= 1, group="g")
AddDensity( name="h25",dx= 0, dy= 1, dz=-1, group="g")
AddDensity( name="h26",dx= 0, dy=-1, dz=-1, group="g")
if (Options$OutFlow){
